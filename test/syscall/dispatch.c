...
DEFINE_SYSCALL_STUB(syscall_memory_allocate, SYSCALL_MEMORY_ALLOCATE)
DEFINE_SYSCALL_STUB(syscall_send_message, SYSCALL_SEND_MESSAGE)
DEFINE_SYSCALL_STUB(syscall_recv_message, SYSCALL_RECV_MESSAGE)
